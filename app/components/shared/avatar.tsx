...
const avatarGroupStyles = tv({
  base: '[&_[data-slot=avatar]]:ring-bg flex items-center justify-center -space-x-2 [&_[data-slot=avatar]]:ring-2',
})
...
const avatarStyles = tv({
  base: [
    'bg-secondary relative inline-grid shrink-0 align-middle [--avatar-radius:20%] [--ring-opacity:20%] *:col-start-1 *:row-start-1',
    'loo2ppvkxrcah38e outline-fg/[--ring-opacity] outline outline-1 -outline-offset-1',
  ],
  variants: {
    size: {
      'extra-small': 'size-5',
...
const avatarBadgeStyles = tv({
  base: ['bg-bg ring-bg absolute right-0 bottom-0 z-10 size-3 rounded-full ring-[1.5px]'],
  variants: {
    size: {
