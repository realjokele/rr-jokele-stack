...
const listBoxStyles = tv({
  base: 'flex max-h-96 w-full min-w-72 flex-col gap-y-1 overflow-y-auto rounded-xl border p-1 shadow-lg outline-none',
})
...
const listBoxItemStyles = tv({
  ...
  variants: {
    isFocusVisible: {
      true: 'bg-secondary text-secondary-fg [&:focus-visible_[data-slot=description]]:text-accent-fg/70 [&:focus-visible_[data-slot=label]]:text-accent-fg',
    },
    isHovered: {
      true: 'bg-accent text-accent-fg [&:hover_[data-slot=description]]:text-accent-fg/70 [&:hover_[data-slot=label]]:text-accent-fg [&_.text-muted-fg]:text-accent-fg/80',
    },
    isFocused: {
