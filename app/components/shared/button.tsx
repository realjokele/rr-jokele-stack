...
export const buttonStyles = tv({
  ...
  variants: {
    intent: {
      primary: [
        'outline-primary [--btn-bg:theme(--color-primary/95%)] dark:[--btn-bg:theme(--color-primary/90%)] [--btn-border:var(--color-primary)] [--btn-fg:var(--color-primary-fg)]',
      ...
      secondary: [
        '[--btn-bg:theme(--color-secondary/95%)] [--btn-border:theme(--color-secondary-fg/10%)] dark:[--btn-bg:theme(--color-secondary/85%)] dark:[--btn-border:theme(--color-secondary-fg/7%)] [--btn-fg:var(--color-secondary-fg)]',
    ...
    appearance: {
      ...
      outline: ['data-hovered:bg-secondary data-pressed:bg-secondary border'],
  ...
  return (
    ...
    >
      <span className="relative inline-flex items-center justify-center">
        ...
        <span
          className={cn('inline-flex items-center justify-center transition-opacity', {
            'opacity-0': isPending,
        ...
        >
          ...
          {children}
          {iconRight && <Icon name={iconRight} className="ml-2 h-4 w-4" />}
        </span>
      </span>
    </ButtonPrimitive>
  )
