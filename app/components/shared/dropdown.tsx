...
const dropdownItemStyles = tv({
  base: [
    ...
    'forced-color:text-[Highlight] group text-fg relative cursor-default rounded-[calc(var(--radius-lg)-1px)] px-[calc(var(--spacing)*2.3)] py-[calc(var(--spacing)*1.3)] text-base outline-0 forced-color-adjust-none select-none sm:text-sm/6 forced-colors:text-[LinkText]',
